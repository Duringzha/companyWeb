...
<div class="container">
    <h2>账户信息</h2>
    <h3>Welcome !</h3>
    <h4><a href="<?php echo base_url(); ?>index.php/manage/loadinfo">公司简介编辑</a></h4>
    ...
    <table>
        ...
        <tr>
            ...
            <td> <a href="<?php echo base_url(); ?>index.php/manage/deletepost/<?php echo $item->id; ?>"><?php echo '删除' ?> </a></td>
        </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
